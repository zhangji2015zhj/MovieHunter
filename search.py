...
def search(name):
    try:
        host = 'https://www.hanjula.com'
        url = 'https://www.hanjula.com/index.php?s=home-search-vod&q=' + urllib.parse.quote(gbk2utf(name)) + '&limit=12&timestamp=' + timestamp()
        headers = {
            'User-Agent':'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/72.0.3626.96 Safari/537.36',
            'Host': 'www.hanjula.com',
